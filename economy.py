...
class Economy:
    ...
    def register_consumer(self, agent_id: str, agent: Consumer):
        self.consumer_registry.add_agent(agent_id, agent)

    def register_supplier(self, agent_id: str, agent: Supplier):
        self.supplier_registry.add_agent(agent_id, agent)

    def register_transformer(self, agent_id: str, agent: Transformer):
        self.transformer_registry.add_agent(agent_id, agent)
